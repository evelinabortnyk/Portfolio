...
export const projectsArr = [
    ...
    },
    {
        ...
        'gallery': ['./img/gallery/converter_1.png', './img/gallery/converter_2.png', './img/gallery/converter_3.png',],
        'title': 'Converter',
        'link': 'converter',
    ...
    },
    {
        ...
        'preview': './img/preview/keksobooking-prewiev.png',
        'gallery': ['./img/gallery/keksobooking_1.png', './img/gallery/keksobooking_2.png', './img/gallery/keksobooking_3.png',],
        'title': 'Keksobooking',
        'link': 'keksobooking',
        'description': 'A full-stack web application for browsing and posting property listings. The frontend is built with React and communicates with a Node.js backend to retrieve and manage listings. The application features an interactive Leaflet map with location markers, filtering functionality, and a validated form for creating new listings. The project demonstrates client-server interaction, REST API integration, map integration, and modern frontend development practices.',
        'tags': ['React', 'Node.js', 'Express', 'Render', 'Leaflet', 'React-router'],
        'features': ['REST API', 'Interactive Map', 'Property Listings', 'Listing Form', 'Filtering'],
        'tasks': [
            'Developed a responsive and modern UI with React.',
            'Built RESTful API and server logic with Node.js and Express.',
            'Implemented an interactive Leaflet map with listing markers.',
            'Developed filtering functionality for listings displayed on the map.',
            'Created a validated form for users to publish their own listings.',
            'Deployed the backend server on Render',
        ],
        'linkShow': 'https://keksobooking-kappa.vercel.app/',
        'linkCode': 'https://github.com/evelinabortnyk/Keksobooking',
    },
    // {
    //     'img': fest,
    //     'preview': festBg,
